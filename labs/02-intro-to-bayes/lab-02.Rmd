...
data = c(1/20.9, 1/69.7, 1/3.6, 1/21.8, 1/21.4, 1/0.4, 1/6.7, 1/10.0)
a = 0.1
b = 1.0
...
par(new=TRUE)
plot(th, posterior, type='l', ylab='Density', lty = 3, lwd = 3, xlab = expression(theta), col='blue', yaxt='n',main='Informative')
```
